...
<svg width="1600" height="1200" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="80" y="170" class="actor" text-anchor="middle">👷 Worker</text>
  
  <rect x="20" y="200" width="120" height="30" class="actor-box" rx="5"/>
  <text x="80" y="220" class="actor" text-anchor="middle">🧑‍💼 Customer</text>
  ...
  <line x1="140" y1="165" x2="730" y2="367" class="connection"/>
  
  <!-- Customer connections -->
  <line x1="140" y1="215" x2="1110" y2="162" class="connection"/>
  <line x1="140" y1="215" x2="1110" y2="232" class="connection"/>
  ...
  <text x="220" y="870" class="subtitle">Primary Actors: 3 (Admin, Worker, Customer)</text>
...
// Write SVG to file
const svgPath = path.join(__dirname, 'use_case_diagram.svg');
fs.writeFileSync(svgPath, svgContent);

console.log('SVG file created: use_case_diagram.svg');

// Try to convert to PNG using a simple approach
...
console.log('3. Use command line tools like: npm install -g svg2png && svg2png use_case_diagram.svg');
console.log('4. Use Inkscape (free): inkscape use_case_diagram.svg --export-png=use_case_diagram.png');

// Also create a simple HTML file that can be screenshotted
const htmlContent = `<!DOCTYPE html>
<html>
<head>
    <title>AutoWeave ERP Use Case Diagram</title>
    <style>
...
<body>
    <div class="container">
        <h1>AutoWeave ERP - Use Case Diagram</h1>
        <img src="use_case_diagram.svg" alt="Use Case Diagram"/>
        <p>Right-click and save as PNG, or use browser's print to PDF functionality</p>
    </div>
</body>
</html>`;

const htmlPath = path.join(__dirname, 'use_case_diagram_viewer.html');
fs.writeFileSync(htmlPath, htmlContent);

console.log('HTML viewer created: use_case_diagram_viewer.html');
